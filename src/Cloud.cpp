...
void Cloud::addPost(string title, string message, string image_address, string author, PostType post_type, string extra) {
    posts.push_back(new Post(title, message, post_number, image_address, author, post_type, extra));
    post_number++;
}
