...
const std::string utilitiesHeaderPath = "utilities.hpp";
const std::string utilitiesPath = "src/utilities.cpp";
const std::string strutilsHeaderPath = "strutils.hpp";
const std::string strutilsPath = "src/strutils.cpp";
